...
0000000000001060 <_start>:
    ...
    1078:	48 8d 3d 05 01 00 00 	lea    0x105(%rip),%rdi        # 1184 <main>
...
0000000000001184 <main>:
    ...
    1190:	bf 52 bf 01 00       	mov    $0x1bf52,%edi
    1195:	e8 af ff ff ff       	call   1149 <While>
    119a:	89 45 f8             	mov    %eax,-0x8(%rbp)
    119d:	bf 42 4b 1d 00       	mov    $0x1d4b42,%edi
    11a2:	e8 be ff ff ff       	call   1165 <Goto>
    11a7:	89 45 fc             	mov    %eax,-0x4(%rbp)
    ...
    11be:	e8 8d fe ff ff       	call   1050 <printf@plt>
    11c3:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11c6:	89 c6                	mov    %eax,%esi
    11c8:	48 8d 05 40 0e 00 00 	lea    0xe40(%rip),%rax        # 200f <_IO_stdin_used+0xf>
    11cf:	48 89 c7             	mov    %rax,%rdi
    11d2:	b8 00 00 00 00       	mov    $0x0,%eax
    11d7:	e8 74 fe ff ff       	call   1050 <printf@plt>
